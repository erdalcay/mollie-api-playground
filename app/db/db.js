...
const ordersdb = new Datastore({
	filename: path.join(__dirname, '/orders.db'), autoload: true
});
ordersdb.persistence.setAutocompactionInterval(5);
...
class DB {
	 ...
	 * @param {string} [document.orderId] - Order I
